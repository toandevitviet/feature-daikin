...
config(['$routeProvider', function($routeProvider) {
  $routeProvider
  .when('/airflow_3d', {templateUrl: 'partials/airflow_3d.html', controller: 'Airflow_3d'})
  .when('/elnverte', {templateUrl: 'partials/elnverte.html', controller: 'Elnverte'}) 
  .when('/intelligent_eye', {templateUrl: 'partials/intelligent_eye.html', controller: 'Intelligent_eye'}) 
  .when('/airflow_powerful', {templateUrl: 'partials/airflow_powerful.html', controller: 'Airflow_powerful'})
  .when('/cooling_powerful', {templateUrl: 'partials/cooling_powerful.html', controller: 'Cooling_powerful'})
  .when('/air_clean', {templateUrl: 'partials/air_clean.html', controller: 'Air_clean'})
  .when('/saving_energy', {templateUrl: 'partials/saving_energy.html', controller: 'Saving_energy'})
  .when('/quiet_super', {templateUrl: 'partials/quiet_super.html', controller: 'Quiet_super'})
  .otherwise({redirectTo: '/airflow_3d'});
}])
